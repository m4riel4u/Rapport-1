...
- Apprendre à utiliser l'API planifium
- Apprendre à créer un Discord Bot
- Planification et coordination des tâches dans l'équipe 
...
- Nécessité de préciser les exigences avec les clients 
